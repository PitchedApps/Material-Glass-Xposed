...
public class ThemePreferences extends PreferenceFragment {
    ...
    private void initPreferences() {
        ...
        for(int i = 0; i < themeList.length; i++) {
            ...
            pr.setKey(themeList[i][0]); //app name
            pr.setTitle(themeList[i][0]);
            final int finalI = i;
            pr.setOnPreferenceClickListener(new CheckBoxPreference.OnPreferenceClickListener() {
                ...
                public boolean onPreferenceClick(Preference preference) {
                    ...
                    new AlertDialog.Builder(getActivity())
                            .setTitle(themeList[finalI][0])
                            .setMessage("\u2022 " + themeList[finalI][1].replaceAll("/", "\n\u2022")) //app dialog description
        ...
        //set dependency
        for(int i = 0; i < themeList.length; i++) {
            getPreferenceScreen().findPreference(themeList[i][0]).setDependency(MASTER_TOGGLE);
        }
